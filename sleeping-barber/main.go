...
//     goes home
//
// The Sleeping Barber was originally proposed in 1965 by computer science pioneer Edger Dijkstra.
//
...
func main() {
	...
	// add barbers
	shop.addBarbers("Anthibo El Hala'")
	shop.addBarbers("Anthibo2")
	shop.addBarbers("Anthibo3'")
